...
; MsgWarnRunning 'Please close "SABnzbd.exe" first'
  ...
  LangString MsgShowRelNote ${LANG_DANISH} "Vis udgivelsesbem�rkninger"
  ...
  LangString MsgSupportUs   ${LANG_DANISH} "St�tte projektet, donere!"
  ...
  LangString MsgDelSettings ${LANG_FRENCH} "Supprimer les Param�tres"

...
from sabnzbd.utils.internetspeed import internetspeed, measure_speed_from_url, SizeUrlList
...
class TestInternetSpeed:
    ...
    def test_measurespeed_invalid_url(self):
        speed = measure_speed_from_url("www.fake-url-9999999.xyz")

        assert not speed

    def test_measurespeed_valid_url(self):
        speed = measure_speed_from_url(SizeUrlList[0][1])

...
# env SAB_VERSION=X.Y SAB_AVG_BPS=666 python ./Sample-PostProc.py somedir222 nzbname CleanJobName123 Index12 Cat88 \
#                                                                                   MyGroup PP0 https://example.com/
...
try:
    ...
    print("Incorrect number of SAB commandline parameters found (should be 8):", len(sys.argv) - 1)

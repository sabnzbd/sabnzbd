...
#OSX Menu
    ...
    'wizard-tip3@1' : TT('After SABnzbd has finished restarting you will be able to access it at the following location%s'),
    ...
    'wizard-server-help2@1' : TT('Don\'t have a usenet provider? We recommend trying %s.'),

...
SKIN_TEXT = {
    ...
    "explain-enable_https": TT(
        "Enable accessing the interface from a HTTPS address. Modern web browsers and other clients will not accept self-signed certificates and will give a warning and/or won't connect at all."
    ),

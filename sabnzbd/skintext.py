...
# Config->General
    ...
    'explain-history_retention' : TT('Automatically delete completed items from History. Beware that Duplicate Detection and some external tools rely on History information.'),
    'history_retention-all' : TT('Keep all items'),
    'history_retention-number' : TT('Keep maximum number of History items'),
    'history_retention-days' : TT('Keep items maximum number of days'),
    'history_retention-none' : TT('Do not keep any completed History items'),

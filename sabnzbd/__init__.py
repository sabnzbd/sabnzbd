...
def initialize(pause_downloader = False, clean_up = False, evalSched=False, repair=0):
    ...
    cfg.pushover_token.callback(sabnzbd.growler.change_value)
    cfg.pushover_userkey.callback(sabnzbd.growler.change_value)
    cfg.pushover_device.callback(sabnzbd.growler.change_value)

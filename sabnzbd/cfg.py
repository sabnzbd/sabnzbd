...
num_simd_decoders = OptionNumber("misc", "num_simd_decoders", 1)
...
user_defined_well_known_extensions = OptionList("misc", "user_defined_well_known_extensions", ["myext", "specialext"])

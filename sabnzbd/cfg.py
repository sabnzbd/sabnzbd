...
pushover_token = OptionStr('growl', 'pushover_token')
pushover_userkey = OptionStr('growl', 'pushover_userkey')
pushover_device = OptionStr('growl', 'pushover_device')
pushover_enable = OptionBool('growl', 'pushover_enable')

...
receive_threads = OptionNumber("misc", "receive_threads", 1 + (cpu_count() or 4) // 2, minval=1)
num_simd_decoders = OptionNumber("misc", "num_simd_decoders", 1 + (cpu_count() or 4) // 4, minval=1)

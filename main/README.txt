...
* Multi-language (we speak English, French and Dutch) and learning more fast.
* Revamped Config System - The configuration backend was overhauled in 0.5.
  ...
  Also no internal restarts are required anymore (except for skin changes).
...
The API:
* Totally overhauled for 0.5. Basically, you now have full access to nearly everything about

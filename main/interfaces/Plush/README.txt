...
Plush 3.0 for SABnzbd+ 0.5 | July 7 2009
...
See LICENSE-LGPL
The following image is composed of images from the Nuvola icon set:
templates/static/images/plush-default/config-sprite.png
...
...with the exception of and arrows-ffffff.png which are part of the jQuery Superfish plugin -- See LICENSE-MIT & LICENSE-GPL

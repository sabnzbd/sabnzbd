...
PNFO_DELETE_FIELD = 2
PNFO_NZO_ID_FIELD = 3
PNFO_FILENAME_FIELD = 4
PNFO_UNPACKSTRHT_FIELD = 5
PNFO_BYTES_LEFT_FIELD = 6
PNFO_BYTES_FIELD = 7
PNFO_AVG_DATE_FIELD = 8
PNFO_FINISHED_FILES_FIELD = 9
PNFO_ACTIVE_FILES_FIELD = 10
PNFO_QUEUED_FILES_FIELD = 11
